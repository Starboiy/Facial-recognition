...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        # 1st Image
        img = Image.open(r"C:\Mini_Peroject\Photos\scan.png")
        ...
        # 2nd Image
        img1 = Image.open(r"C:\Mini_Peroject\Photos\college.jpeg")
        ...
        # 3rd Image
        img2 = Image.open(r"C:\Mini_Peroject\Photos\face.webp")
        ...
        #Entry button
        img4 = Image.open(r"C:\Mini_Peroject\Photos\smart.webp")
        ...
        b1_1=Button(bg_img,text="Entry Details",command=self.employee_details,cursor="hand2",font=("times new roman",15,"bold"),bg="darkblue",fg="white")
        b1_1.place(x=100,y=300,width=220,height=40)

        #Detect Face button
        img5 = Image.open(r"C:\Mini_Peroject\Photos\man.jpeg")
        ...
        img6 = Image.open(r"C:\Mini_Peroject\Photos\3p.jpg")
        ...
        #Help button
        img7 = Image.open(r"C:\Mini_Peroject\Photos\bg.jpg")
        ...
        #Train Face button
        img8 = Image.open(r"C:\Mini_Peroject\Photos\fin.webp")
